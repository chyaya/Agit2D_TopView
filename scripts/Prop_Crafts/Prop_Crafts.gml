...
Prop_AddCraft(Craft.IronTool, Item.IronTool, 3000, [Item.Wood, Item.IronIngot], [1, 1], oBlastFurnace);
...
Prop_AddCraft(Craft.IronSword, Item.IronSword, 3000, [Item.Wood, Item.IronIngot], [1, 1], oBlastFurnace);
