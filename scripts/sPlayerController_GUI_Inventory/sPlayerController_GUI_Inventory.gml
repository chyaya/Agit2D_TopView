...
if(m_Input_AxisL_Step && m_Input_AxisL_Left || m_Input_DPad_Left)
	--m_SelectedSlotX;
else if(m_Input_AxisL_Step && m_Input_AxisL_Right || m_Input_DPad_Right)
	++m_SelectedSlotX;
else if(m_Input_AxisL_Step && m_Input_AxisL_Up || m_Input_DPad_Up)
	--m_SelectedSlotY;
else if(m_Input_AxisL_Step && m_Input_AxisL_Down || m_Input_DPad_Down)
	++m_SelectedSlotY;
